<?php
//Need to create a new table called Archive
//CREATE TABLE Archive(
//    item_id INT(11) NOT NULL,
//    email_post varchar(20) NOT NULL,
//  PRIMARY KEY(item_id),
...
if (isset($_POST['but_archive'])){
    $id_selected = $_POST['archive_id'];
    $sql3 = "INSERT INTO `Archive`(`item_id`, `email_archive`) VALUES ($id_selected,'$myusername')";
    ...
    if (mysqli_affected_rows($conn) > 0){
        ...
        echo "Archive failed: ".mysqli_error($conn);
    }
}
...
<div id="wrapper">
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <h3>Enter the item id you want to archive.</h3>
            <form method="post" action="">
                <div id="div_login">
                    <div>
                        <input type="text" class="textbox" id="archive_id" name="archive_id" placeholder="Item ID" required/>
                        <input type="submit" value="Submit" name="but_archive" id="but_archive" />
                    </div>
                </div>
            </form>
            <br>
