...
//
//				if (mysqli_num_rows($result) == 1) {
//					// the name exists in FG
					$sql = "DELETE FROM Belong WHERE email='$friendemail' AND owner_email='$myusername'"; // Delete from Belong
					$result = mysqli_query($conn, $sql);
					echo "Your friend has been successfully removed from the friend group.<br>";
					
					$sql = "DELETE FROM Tag WHERE email_tagged='$friendemail' AND email_tagger='$myusername'"; // Delete tags
					$result = mysqli_query($conn, $sql);
					echo "Your friend has been successfully removed from the tag.<br>";
					
					
//					
//				}
//				else {
//					echo "That name does not exist in this friend group";
//				}
//			}
//			else {
